        ...
        <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex gap-2">
                    ...
                    >
                        <Camera className="w-4 h-4" /> Scan rápido
                    </button>
                    <button
                        onClick={() => openCreate()}
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="bg-gray-50/80 border-b border-gray-100">
                                    ...
                                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider hidden md:table-cell">SKU / Barcode</th>
                                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider hidden lg:table-cell">Categoria</th>
                                    <th className="text-right px-4 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider hidden sm:table-cell">Preço</th>
                                    <th className="text-right px-4 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Estoque</th>
                                ...
                                {products.map((p) => {
                                    ...
                                    return (
                                        <tr key={p.id} className="hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td className="px-4 py-3 text-gray-500 hidden lg:table-cell">{getCategoryName(p.category_id)}</td>
                                            <td className="px-4 py-3 text-right font-medium text-gray-700 hidden sm:table-cell">
                                                R$ {p.price.toFixed(2)}
                                            </td>
                                                ...
                                                <div className="flex items-center justify-end gap-1">
                                                    ...
                                                    {deleteConfirm === p.id ? (
                                                        <div className="flex items-center gap-1">
                                                            <button onClick={() => handleDelete(p.id)} className="px-2 py-1 text-[10px] font-bold bg-red-500 text-white rounded-md">Sim</button>
